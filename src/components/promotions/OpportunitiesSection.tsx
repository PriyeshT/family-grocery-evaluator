  ...
  return (
    <div className="mt-10 pt-8 border-t border-gray-200">
      <div className="flex items-center gap-2 mb-1">
        ...
        <h2 className="text-lg font-bold text-gray-800">Worth adding this week</h2>
      ...
      {!loading && !error && opportunities.length === 0 && (
        <div className="rounded-lg border border-gray-200 bg-gray-50 px-4 py-6 text-center">
          <p className="text-sm text-gray-500">No additional opportunities found this week — your list already covers the best deals!</p>
        </div>
      )}
          ...
          {opportunities.map((item) => {
            ...
            return (
              <div
                ...
                className="rounded-lg border border-violet-100 bg-white p-4 shadow-sm hover:shadow-md transition-shadow flex flex-col gap-3"
              >
                  ...
                  <div className="flex items-center gap-2">
                    {onList || justAdded ? (
                      ...
                      <button
                        ...
                        className="px-3 py-1.5 bg-violet-600 hover:bg-violet-700 text-white text-xs font-medium rounded-md transition-colors"
                      >
                        + Add to list
                      </button>
                    )}
